...
st.plotly_chart(fig,figsize=(100, 50))


# Menampilkan data lagi di Streamlit

# Contoh plot Matplotlib
# Misalkan 'x' dan 'y' adalah data yang Anda miliki untuk grafik linier
x = range(30)  # Ganti dengan data sebenarnya
y = [i**2 for i in x]  # Ganti dengan data sebenarnya
